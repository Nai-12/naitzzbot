...
function title() {
      console.clear()
	  console.log(chalk.bold.white(figlet.textSync('Naitzz Bot', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n${chalk.yellow('[ Created By ')} ${chalk.green('Naitzz ]')}\n\n${chalk.red('Follow Insta Dev')} : ${chalk.green('@naitzzxyz')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.green('+62 896-6744-0607')}\n`))
}
